# EgoCAMRA
we propose a multimodal graph-based framework EgoCAMRA (\underline{Ego}centric \underline{C}onfidence-\underline{A}ware Residual Random Walks for \underline{M}ulti-Action \underline{R}ecognition and \underline{A}nticipation) for recognition of multiple co-occurring actions and anticipation in egocentric videos.
